...
lima = 4099; limb = 32899;
if(inner_split == 1)
    lima_int = 10099;
    limb_int = 16699;
end
z1 = readtable('csv/log 1/raw_imu_gps_2022-05-04-01-13-06.csv');
z2 = readtable('csv/log 1/mag_imu_gps_2022-05-04-01-13-06.csv');
z3 = readtable('csv/log 1/data_imu_gps_2022-05-04-01-13-06.csv');
v1 = load('videos/14/DJI_0014all.mat');
v2 = load('videos/15/DJI_0015all.mat');
filename = 'log1_aligned.csv';
...
clear z1 z2 z3;
rob_x_master = vertcat(v1.rob_x',v2.rob_x');
rob_y_master = vertcat(v1.rob_y',v2.rob_y');
