...
def abolldeepio_pos_generator(net_inp_mat, size_of_each, 
    ...
    y_pred = my_model.predict([cur_inp[:,:,0:3],cur_inp[:,:,3:6],cur_inp[:,:,6]])
...
def aboldeepio_GT_pos_generator(disp, head, size_of_each, 
